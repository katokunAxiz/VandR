	...
	<div class="container">
		<form class="form-signin">
			...
			<button type="button"
				...
				data-toggle="modal" data-target="#exampleModalCenter">登録する</button>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalCenterTitle">登録確認</h5>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-warning"
								onclick="location.href='Tanae-UserInsertResult'">更新する</button>
						</div>
					</div>
				</div>
			</div>

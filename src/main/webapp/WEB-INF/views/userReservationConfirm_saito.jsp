...
<body>
	...
	<br>
	<div class="container">
		<form action="userReservationResult_saito" class="form-signin">

			<img class="mb-4"
				src="https://getbootstrap.com/assets/brand/bootstrap-solid.svg"
				alt="" width="72" height="72">

			<h1 class="h3 mb-3 font-weight-normal">予約内容の確認</h1>
			<br>

			<p>
				まだ予約は完了していません。<br> ご予約内容の最終確認をしてください。
			</p>
			...
			<p style="color: #ff0000">
				ご連絡のないキャンセルをされた場合、<br> ご予約を承れなくなることがあります。
			</p>
			<div class="row">
				<div class="col">
					<button class="btn btn-lg btn-warning btn-block" type="submit">予約を確定する</button>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col">
					<button class="btn btn-outline-secondary btn-sm" type="button"
						onclick="location.href='userReservation_saito'">予約内容の入力に戻る</button>
				</div>
			</div>
		</form>
	</div>
